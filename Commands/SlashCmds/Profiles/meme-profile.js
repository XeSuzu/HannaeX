...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const topMeme = await Meme.findOne({ authorId: userId, guildId: guildId })
        .sort({ points: -1 });
      ...
      const totalReputacion = totalPointsResult.length > 0 ? totalPointsResult[0].totalPoints : 0;
      ...
      const errorEmbed = new EmbedBuilder()
        ...
        .setDescription('Ocurrió un error al intentar mostrar la reputación. Por favor, inténtalo de nuevo más tarde.');

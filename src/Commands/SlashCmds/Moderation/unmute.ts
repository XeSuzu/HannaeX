    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .setDescription(`Se han limpiado las infracciones de **${target.user.tag}**. ¡Espero que haya aprendido su lección! 🌸`)
            ...
            await interaction.reply({ 
                content: "🌸 Hubo un problemita al intentar perdonar al usuario. Revisa mis permisos.", 
                ephemeral: true 
            });
        }
    }
